...
if (is4xAndroid && isNativeAndroidBrowser) {
    ...
    style.innerHTML = 'div,p,h1,h2,h3,h4,h5,h6,section,header,footer,span{background-image: url(data:image/gif;base64R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==);}';
